...
export class TransportationPage {
  ...
  public createTransportationForm;
  public mapForm;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,  public loadingCtrl: LoadingController,
   ...
   this.createTransportationForm = this.fb.group({
  ...
  onSubmit(action: any): void {
    ...
    if (this.createTransportationForm.valid) {
      
      //Kullanıcıya oluşturulduğuna dair mesaj görüntüleniyor
      let loader = this.loadingCtrl.create({
        content: 'Transportation step added...'
      });
     ...
     loader.present();
      ...
      // Data servis arayüzünün veri ekleme fonksiyonu kullanılarak veritabanına veri ekleniyor
         ...
         self.compl.stepSequences.push({id: newAction.key, type: "TRANSPORTATION"});
